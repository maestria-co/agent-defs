...
The valuable elements of this protocol (XML tag conventions, self-verify, output format discipline) are also reflected in all skill SKILL.md files and `skills/_shared/conventions.md`.
